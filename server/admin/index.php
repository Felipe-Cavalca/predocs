...
if ($_POST) {
    $Arquivo->gravar($_POST['arquivo'], $_POST['conteudo']);
}
?>
...
<body>
    <section id="body" class="scale-transition scale-out">
        ...
        <form action="#" method="POST">
            ...
            <textarea id="variavies_core_server" name="conteudo"><?= $Arquivo->ler($URLS['coreServer'] . 'vars.php') ?></textarea>
            <br>
        ...
        <form action="#" method="POST">
            ...
            <textarea id="variavies_core_server" name="conteudo"><?= $Arquivo->ler($URLS['web'] . 'css/variaveis.css') ?></textarea>
            <br>
            <button type="submit">Salvar</button>
        </form>
        ...
        <form action="#" method="POST">
            ...
            <textarea id="variavies_core_server" name="conteudo"><?= $Arquivo->ler($URLS['web'] . 'core/index.js') ?></textarea>
            <br>
            <button type="submit">Salvar</button>
        </form>
        ...
        <form action="#" method="POST">
            ...
            <textarea id="variavies_core_server" name="conteudo"><?= $Arquivo->ler($URLS['app'] . 'index.html') ?></textarea>
            <br>
            <button type="submit">Salvar</button>
        </form>
